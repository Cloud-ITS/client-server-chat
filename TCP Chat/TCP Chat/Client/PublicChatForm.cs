...
namespace Client
{
    public partial class PublicChatForm : Form
    {
        ...
        private PrivateChatUser pChat1;
        ...
        private void privateChat_Click(object sender, EventArgs e)
        {
            ...
            //foreach (var client in from ListViewItem item in userList.SelectedItems select (ClientUser)item.Tag)
            //{
            //    client.Send("Chat|");
            //    pChat1 = new PrivateChatUser(this);
            //    pChat1.Show();
            //}
        }
